...
class OdooPlayGround(models.Model):
    ...
    # - self: Current Object
    # - self.env: Odoo Envoirnment on which the action is triggered
    ...
    # - self.env.is_superuser: return whether the envoirnment is in superuser mode.
    # - self.env.company: return the current company as instance
